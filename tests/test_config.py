...
from config import load_settings, normalize_transport, parse_bool, parse_port  # noqa: E402
...
class ConfigTestCase(unittest.TestCase):
    def test_load_settings_uses_browser_mcp_defaults(self) -> None:
        ...
        self.assertEqual(settings.browser_mcp_transport, "streamable-http")
    ...
    def test_load_settings_parses_browser_mcp_overrides(self) -> None:
        ...
        self.assertEqual(settings.browser_mcp_transport, "sse")
    ...
    def test_transport_aliases_normalize_to_streamable_http(self) -> None:
        self.assertEqual(normalize_transport("httpstream"), "streamable-http")
        self.assertEqual(normalize_transport("streamable_http"), "streamable-http")
