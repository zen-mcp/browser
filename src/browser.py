...
class BrowserRuntime:
    ...
    def resolve_file_path(self, requested_name: str, category: str = "artifacts") -> Path:
        if category.lower() not in {"artifacts", "downloads"}:
            raise ValueError("Category must be 'artifacts' or 'downloads'.")
